...
export class PostDetailsModalComponent implements OnInit, OnDestroy {
  ...
  /**
   * Retrieves post's details from postId
   * @param postId `number`.
  ...
  /**
   * Present options menu for the post, if the post is not yet published it is editable
   */
  ...
  /**
   * Ask user's confirmation before deleting a post
   */
